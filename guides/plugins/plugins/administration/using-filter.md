...
Furthermore you should have a look at our [add filter](./add-filter.md) guide, since this guide is build upon it.
...
Below you can see two example implementation, how it could be done with single argument filters.
